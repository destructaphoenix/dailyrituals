...
**The queue holds only the owner-gated row.** IMP-130 is done (archived to `docs/build-log.md`, commit
`111c3de`) and IMP-128 stays owner-gated — **there is no row a build chat may take right now.**
...
commits `87771c4`, `d57dc2d`, `0502790`, `402391b`, `0a2f595`, `111c3de`).
