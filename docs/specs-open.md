...
| 8 | [IMP-060 — a candle burns without telling you](#imp-060--a-candle-burns-without-telling-you) | OTA |
| 9 | [IMP-059 — the app has one accessibility label](#imp-059--the-app-has-one-accessibility-label) | OTA |
| 10 | [IMP-058 — prompt packs](#imp-058--prompt-packs) | OTA |

> **IMP-057 is deliberately absent.** It is reserved for the historical `dayKey` migration that
> [IMP-056](#imp-056--a-day-is-the-day-you-lived-not-the-day-in-greenwich) defers, and it cannot be
> written until IMP-056's step-5 reporter says how many entries are affected. **Do not reuse the number.**
>
