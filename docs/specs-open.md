...
**The backlog is empty.** Every open spec has shipped code; see `PROGRESS.md`'s Improvements backlog table
for what's next (a new IMP scoped by Opus, or the phase ladder).
