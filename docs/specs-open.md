...
_No open specs right now._ **IMP-063 through IMP-068 (the WALK-04/06/07 findings) have all landed** — full
detail archived in [`docs/build-log.md`](build-log.md). The next spec appears here when Opus scopes one from
a fresh owner-filed issue or a failed walk.
