...
**The exact next step.** The backlog is now empty for a build chat (IMP-128 stays owner-gated). A design chat
sends D-15 or D-16 — D-15 can now point at the generated Home card instead of pasting source. WALK-25 is
agent-runnable on an emulator whenever raw captures are wanted, sequenced behind D-16.
