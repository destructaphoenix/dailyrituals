...
> | --- | --- |
> | a **build task** | 🔴 **[IMP-108](docs/specs-open.md#imp-108) first** — a paying member is still charged embers for five palettes/skies the paywall says they own (`PLUS_PERKS[0]`, live since 2026-09-05). Then **[IMP-109](docs/specs-open.md#imp-109)** — the shortfall toast never names the price or the balance. Both opened by the owner 2026-09-10 from WALK-19 step 7, both fully specced, no decisions left. |
