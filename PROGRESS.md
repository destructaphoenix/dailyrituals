...
| IMP-019 | Premium dark-mode redesign ("Embers in the Dark") — true-black AMOLED, ember-glow hero (no moon), in line with light mode; behind a one-line revert flag (classic dark stays intact) | OTA | 🟡 Code done; owner screenshot review pending |
