...
### IMP-014 — Missed days show a skull 💀, not a blank cell (Today week strip + Reflections heatmap)   ·   Lane: OTA   ·   Status: ✅ (code; runtime walk + ship pending)
...
### IMP-015 — "What should we call you?" is mandatory (can't skip past Personalize blank)   ·   Lane: OTA   ·   Status: ✅ (code; runtime walk + ship pending)
