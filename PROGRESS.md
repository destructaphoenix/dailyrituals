...
| IMP-019 | Premium dark-mode redesign — true-black AMOLED, premium hero, in line with light mode; behind a one-line revert flag (classic dark stays intact) | OTA | ✅ (shipped OTA; runtime walk pending) |
