...
> **The retrieval track:** **IMP-035 search** ✅ **code-complete** — **NEXT: IMP-036 edit/delete** → **IMP-037 moods** → **IMP-047 deeper insights** (makes dead perk #5 real; needs 037).
...
**Current stack:** Expo SDK **54** · React Native **0.81.5** · React **19.1.0** · **Legacy Architecture** (`expo.newArchEnabled: false`, held deliberately — SDK 55 drops Legacy and that migration is its own future task) · `compileSdkVersion`/`targetSdkVersion` **36**, `minSdkVersion` **24** · `npm test` → **431 passed, 49 suites**. Details in [`docs/playbook.md`](docs/playbook.md).
