...
**The exact next step.** Either take **IMP-093** (build chat — read its "the obvious fix is the wrong one"
paragraph first), or take a walk sitting. ⚠️ **One tap is still owed on WALK-19: the aeroplane-mode
Restore check**, IMP-092's second half. **WALK-07, WALK-03 step 4 and WALK-11 are all ready** but need the
